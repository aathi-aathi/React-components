...
function App() {
  ...
  return (
    ...
    <div className='all-features'>
      {core_contents.map(((val,idx)=>(<Images model={val}  key={idx} style={cardstyle} des_content={des_content}/> )))}
    </div>

    <h1>What people are saying...</h1>

    <div className='All-features'>{persons.map(((val,idx)=>(<People model={val}  key={idx} style={featurestyle} 
    imgstyle={{
          height :'200px',
          borderRadius:'50%',
